export const TypescriptIcon = ({ fillColor = "#F97316" }: any) => {
  return (
...
export const BitbucketIcon = ({ fillColor = "#F97316" }: any) => {
  return (
    <svg
...
export const AtlassianIcon = ({ fillColor = "#F97316" }: any) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
      <path
        fill={fillColor}
        d="M15.13 24h8.166a.702.702 0 0 0 .628-1.017S12.932.924 12.655.375c-.248-.497-.881-.506-1.2.005V.379c-5.733 9.066-.398 16.341 3.047 23.227a.702.702 0 0 0 .628.394z"
      />
      <path
        fill={fillColor}
        d="M5.972 11.211.075 22.977a.704.704 0 0 0 .628 1.017h8.203a.675.675 0 0 0 .628-.394c1.777-3.647.708-9.202-2.4-12.52-.362-.384-.924-.361-1.162.131z"
      />
    </svg>
  );
};
